...
flakeはNode.js、pnpm、Wrangler、Svelte/TypeScript関連の開発ツールを提供します。
...
dev shell内では `node`、`pnpm`、`wrangler`、`svelte-language-server`、`typescript-language-server` が利用できます。
...
- `pnpm format:check`: Prettierで整形済みか確認
