...
5. Set frontmatter to `title: "[Transcript/Vocabulary] <video title>"`, include the fixed categories `english-learning` and `transcript` plus one topic-specific category, and retain the generated date and slug.
