...
## その他の工夫: マウス操作もCornixでできるようにして触る時間を長くする

またその他の工夫として、マウス操作もCornixでできるようにして触る時間を長くし、少しでもCornixに慣れられるようにしました。

具体的にはレイヤー3のhjklキーにマウスの左右上下を割り当てて、dfキーにマウスの右クリックと左クリックを割り当てています。

<img src="./images/cornix-layer3.png" alt="cornix-layer3" width="640" />

またaキーにマウスカーソルの速度を上げるキーを配置しており、そちらを適宜押しながら操作をしています。

ただ、それでもカーソル速度は速くないので、まぁ慣れるまでの工夫といったところでしょうか。
